 ...
 * @author pc
 */
public class DeletarDentisa extends javax.swing.JFrame {

    private final DentistaCrud Controlador;
    private TelaCrudsDentista view;

    /**
     * Creates new form DeletarDentisa
     */
    public DeletarDentisa() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Deletar Dentista");
        ...
        lblSucesso.setText("Dentista Deletado com Sucesso");
    ...
    private void btnDeletarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeletarActionPerformed
        ...
        String resumo= Controlador.BuscarDentista("SELECT *FROM dentista WHERE idDentista=?", campoBusca);
    ...
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        String campoBusca=getTxtCPF().getText();
        String x = null;
        String nome=Controlador.DeletarDentista("DELETE FROM dentista WHERE idDentista = ?", campoBusca);
        btnMenuPrincipal.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletarDentisa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeletarDentisa().setVisible(true);
            }
        });
    }
    ...
    public JTextArea getTxtResumoPaciente() {
        return txtResumoPaciente;
    }

    public void setTxtResumoPaciente(JTextArea txtResumoPaciente) {
        this.txtResumoPaciente = txtResumoPaciente;
    }
